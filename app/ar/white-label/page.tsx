...
export const metadata: Metadata = {
  title: 'White-Label تصميم المواقع, التطوير & AI for Agencies | Aenfinite',
  description: 'Scale your وكالة رقمية with our white-label design, custom development, and AI automation partner services. 100% unbranded, fixed wholesale pricing, and direct senior engineering.',
  ...
  twitter: {
    ...
    title: 'White-Label تصميم المواقع & AI for Agencies | Aenfinite',
...
<div class="header" style="min-height:42vh;display:flex;align-items:center;padding:130px 24px 50px;">
  <div style="max-width:1100px;margin:0 auto;width:100%;">
    <div class="title title__default"><h1 style="font-size:clamp(32px,5.5vw,56px);line-height:1.15;margin:0 0 20px;">White-Label تصميم المواقع &amp; AI for Agencies</h1></div>
    ...
    <p style="margin-top:28px;">
      <a href="/ar/contact/" class="button" style="display:inline-block;background:#227bf3;color:#fff;padding:15px 32px;border-radius:8px;font-weight:600;font-size:16px;text-decoration:none;">Book a Partner Introduction Call</a>
    </p>
  </div>
</div>
...
<section ${S}>
  <div style="text-align:center;max-width:820px;margin:0 auto 40px;">
    <h2 ${H2}>White-Label Service Offerings for الوكالة Partners</h2>
      ...
      <div style="border:1px solid rgba(128,128,128,0.22);border-radius:14px;padding:28px;background:rgba(255,255,255,0.03);display:flex;flex-direction:column;justify-content:space-between;">
        <div>
          ...
          <h3 style="font-size:22px;font-weight:700;margin:0 0 12px;line-height:1.3;">
            <a href="/ar/white-label/${svc.slug}/" style="color:inherit;text-decoration:none;">${svc.name}</a>
          </h3>
          ...
          <div style="font-size:13px;padding:10px 14px;background:rgba(34,123,243,0.08);border-left:3px solid #227bf3;border-radius:4px;margin-bottom:18px;line-height:1.5;">
            <strong>الوكالة Advantage:</strong> ${svc.problemStat}
          </div>
        </div>
        <div>
          <a href="/ar/white-label/${svc.slug}/" style="display:inline-flex;align-items:center;font-weight:600;font-size:15px;color:#227bf3;text-decoration:none;">
...
<section ${S}>
  <div style="background:linear-gradient(135deg,rgba(34,123,243,0.08) 0%,rgba(34,123,243,0.02) 100%);border:1px solid rgba(34,123,243,0.2);border-radius:16px;padding:36px;margin:20px 0;">
    <h2 ${H2}>How the الوكالة Partnership Works</h2>
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:20px;margin-top:24px;">
      <div style="padding:16px;border-left:3px solid #227bf3;background:rgba(255,255,255,0.02);">
        ...
        <p style="font-size:14px;line-height:1.6;margin:8px 0 0;opacity:0.85;">إرسال us your Figma file, client brief, or wireframe. We provide a guaranteed wholesale quote within 24 hours.</p>
      </div>
      <div style="padding:16px;border-left:3px solid #227bf3;background:rgba(255,255,255,0.02);">
        <strong style="font-size:18px;color:#227bf3;">2. Seamless التطوير</strong>
...
<section class="aen-faq-block" ${S}>
  <h2 ${H2}>الأسئلة الشائعة for الوكالة Partners</h2>
...
<section ${S} style="text-align:center;padding:30px 24px 60px;">
  <div style="background:rgba(255,255,255,0.02);border:1px solid rgba(128,128,128,0.2);border-radius:16px;padding:40px 24px;">
    ...
    <a href="/ar/contact/" class="button" style="display:inline-block;background:#227bf3;color:#fff;padding:14px 32px;border-radius:8px;font-weight:600;text-decoration:none;">Schedule a Partner Discovery Call &rsaquo;</a>
  </div>
</section>
`;
}
    ...
    '@graph': [
      {
        '@type': 'Service',
        '@id': `${url}#service`,
        name: 'White-Label تصميم المواقع, التطوير & AI for Agencies',
        serviceType: 'White-Label الوكالة الخدمات',
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'White-Label الخدمات', item: url },
        ],
      },
    ],
  };
