...
function buildHubContent(): string {
  ...
  const cards = USE_CASES.map(uc => `
    <a href="/ko/use-cases/${uc.slug}/" style="text-decoration:none;color:inherit;display:block;background:rgba(255,255,255,0.03);border:1px solid rgba(128,128,128,0.2);border-radius:16px;padding:28px 24px;transition:all 0.3s ease;position:relative;overflow:hidden;">
...
<div class="header aen-dark-mode" style="min-height:42vh;display:flex;align-items:center;padding:130px 24px 50px;">
  <div style="max-width:1100px;margin:0 auto;width:100%;">
    ...
    <div style="display:flex;gap:16px;flex-wrap:wrap;margin-top:28px;">
      ...
      <a href="/ko/contact/" class="button" style="display:inline-block;background:transparent;color:inherit;padding:14px 32px;border-radius:8px;font-weight:600;text-decoration:none;border:1px solid rgba(128,128,128,0.3);">Talk to Our Team &rsaquo;</a>
    </div>
  </div>
</div>
...
<section ${S}>
  ...
  <div style="display:flex;flex-wrap:wrap;gap:16px;margin-top:16px;">
    <a href="/ko/tools/vapi/" style="padding:12px 20px;border:1px solid rgba(128,128,128,0.2);border-radius:8px;text-decoration:none;color:inherit;font-weight:600;font-size:15px;transition:border-color 0.2s;">🎙️ Vapi</a>
    <a href="/ko/tools/n8n/" style="padding:12px 20px;border:1px solid rgba(128,128,128,0.2);border-radius:8px;text-decoration:none;color:inherit;font-weight:600;font-size:15px;transition:border-color 0.2s;">⚙️ n8n</a>
    <a href="/ko/tools/ghl/" style="padding:12px 20px;border:1px solid rgba(128,128,128,0.2);border-radius:8px;text-decoration:none;color:inherit;font-weight:600;font-size:15px;transition:border-color 0.2s;">📊 GoHighLevel</a>
    <a href="/ko/tools/make/" style="padding:12px 20px;border:1px solid rgba(128,128,128,0.2);border-radius:8px;text-decoration:none;color:inherit;font-weight:600;font-size:15px;transition:border-color 0.2s;">🔧 Make.com</a>
    <a href="/ko/tools/wordpress/" style="padding:12px 20px;border:1px solid rgba(128,128,128,0.2);border-radius:8px;text-decoration:none;color:inherit;font-weight:600;font-size:15px;transition:border-color 0.2s;">🌐 WordPress</a>
    <a href="/ko/tools/retell/" style="padding:12px 20px;border:1px solid rgba(128,128,128,0.2);border-radius:8px;text-decoration:none;color:inherit;font-weight:600;font-size:15px;transition:border-color 0.2s;">📞 Retell AI</a>
  </div>
</section>
...
<section ${S}>
  ...
  <div style="display:flex;flex-wrap:wrap;gap:12px;margin-top:12px;">
    <a href="/ko/industries/dental/" style="padding:10px 18px;border:1px solid rgba(128,128,128,0.2);border-radius:8px;text-decoration:none;color:inherit;font-size:15px;">🦷 Dental</a>
    <a href="/ko/industries/law-firms/" style="padding:10px 18px;border:1px solid rgba(128,128,128,0.2);border-radius:8px;text-decoration:none;color:inherit;font-size:15px;">⚖️ Law Firms</a>
    <a href="/ko/industries/real-estate/" style="padding:10px 18px;border:1px solid rgba(128,128,128,0.2);border-radius:8px;text-decoration:none;color:inherit;font-size:15px;">🏠 부동산</a>
    <a href="/ko/industries/restaurants/" style="padding:10px 18px;border:1px solid rgba(128,128,128,0.2);border-radius:8px;text-decoration:none;color:inherit;font-size:15px;">🍽️ Restaurants</a>
    <a href="/ko/industries/home-services/" style="padding:10px 18px;border:1px solid rgba(128,128,128,0.2);border-radius:8px;text-decoration:none;color:inherit;font-size:15px;">🔧 Home 서비스</a>
    <a href="/ko/industries/healthcare/" style="padding:10px 18px;border:1px solid rgba(128,128,128,0.2);border-radius:8px;text-decoration:none;color:inherit;font-size:15px;">🏥 헬스케어</a>
    <a href="/ko/industries/construction/" style="padding:10px 18px;border:1px solid rgba(128,128,128,0.2);border-radius:8px;text-decoration:none;color:inherit;font-size:15px;">🏗️ Construction</a>
    <a href="/ko/industries/ecommerce/" style="padding:10px 18px;border:1px solid rgba(128,128,128,0.2);border-radius:8px;text-decoration:none;color:inherit;font-size:15px;">🛒 이커머스</a>
  </div>
</section>
    ...
    '@graph': [
      {
        ...
        serviceType: 'AI 자동화 & Systems Integration',
