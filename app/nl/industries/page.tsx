...
export const metadata: Metadata = {
  title: 'Industry-Specific Webdesign & Ontwikkeling Diensten | Aenfinite',
  ...
  keywords: 'industry web design, web design for dentists, web design for law firms, real estate web design, restaurant websites, healthcare web design, contractor websites, e-commerce-ontwikkeling',
  alternates: { canonical: "https://aenfinite.com/nl/industries/", languages: {"x-default":"https://aenfinite.com/industries/","en":"https://aenfinite.com/industries/","es":"https://aenfinite.com/es/industries/","fr":"https://aenfinite.com/fr/industries/","de":"https://aenfinite.com/de/industries/","it":"https://aenfinite.com/it/industries/","ar":"https://aenfinite.com/ar/industries/","pt":"https://aenfinite.com/pt/industries/","zh":"https://aenfinite.com/zh/industries/","hi":"https://aenfinite.com/hi/industries/","nl":"https://aenfinite.com/nl/industries/","ja":"https://aenfinite.com/ja/industries/","ko":"https://aenfinite.com/ko/industries/"} },
  openGraph: {
    title: 'Industry-Specific Webdesign & Ontwikkeling Diensten | Aenfinite',
  ...
  twitter: {
    ...
    title: 'Industry-Specific Webdesign & Ontwikkeling | Aenfinite',
...
<div class="header" style="min-height:42vh;display:flex;align-items:center;padding:130px 24px 50px;">
  <div style="max-width:1100px;margin:0 auto;width:100%;">
    <div class="title title__default"><h1 style="font-size:clamp(32px,5.5vw,56px);line-height:1.15;margin:0 0 20px;">Webdesign &amp; Ontwikkeling by Industry</h1></div>
    ...
    <p style="margin-top:28px;">
      <a href="/nl/contact/" class="button" style="display:inline-block;background:#227bf3;color:#fff;padding:15px 32px;border-radius:8px;font-weight:600;font-size:16px;text-decoration:none;">Book a free strategy session</a>
    </p>
  </div>
</div>
      ...
      <div style="border:1px solid rgba(128,128,128,0.22);border-radius:14px;padding:28px;background:rgba(255,255,255,0.03);display:flex;flex-direction:column;justify-content:space-between;transition:transform 0.2s, border-color 0.2s;">
        <div>
          ...
          <h3 style="font-size:22px;font-weight:700;margin:0 0 12px;line-height:1.3;">
            <a href="/nl/industries/${ind.slug}/" style="color:inherit;text-decoration:none;">${ind.name}</a>
          </h3>
        ...
        <div>
          <a href="/nl/industries/${ind.slug}/" style="display:inline-flex;align-items:center;font-weight:600;font-size:15px;color:#227bf3;text-decoration:none;">
...
<section ${S}>
  <div style="background:linear-gradient(135deg,rgba(34,123,243,0.08) 0%,rgba(34,123,243,0.02) 100%);border:1px solid rgba(34,123,243,0.2);border-radius:16px;padding:36px;margin:20px 0;">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:24px;margin-top:24px;">
      <div>
        <h3 style="font-size:18px;font-weight:700;margin:0 0 8px;color:#e53935;">❌ Generic Bureau / DIY Template</h3>
...
<section ${S}>
  <h2 ${H2}>Combine Webdesign with 24/7 AI Automatisering</h2>
  ...
  <p style="margin:20px 0;">
    <a href="/nl/ai-solutions/" style="font-weight:700;font-size:17px;color:#227bf3;text-decoration:none;">Explore AI Automatisering by Industry &rsaquo;</a>
  </p>
</section>
...
<section ${S} style="text-align:center;padding:30px 24px 60px;">
  <div style="background:rgba(255,255,255,0.02);border:1px solid rgba(128,128,128,0.2);border-radius:16px;padding:40px 24px;">
    ...
    <a href="/nl/contact/" class="button" style="display:inline-block;background:#227bf3;color:#fff;padding:14px 32px;border-radius:8px;font-weight:600;text-decoration:none;">Schedule Your Consultation &rsaquo;</a>
  </div>
</section>
`;
}
    ...
    '@graph': [
      {
        '@type': 'Service',
        '@id': `${url}#service`,
        name: 'Industry-Specific Webdesign & Ontwikkeling',
        serviceType: 'Webdesign & Custom Softwareontwikkeling',
