...
export const metadata: Metadata = {
  title: 'AI Automatisering & Voice Receptionists by Industry [2026]',
  ...
  twitter: {
    ...
    title: 'AI Automatisering & Voice Receptionists by Industry | Aenfinite',
...
<div class="header" style="min-height:42vh;display:flex;align-items:center;padding:130px 24px 50px;">
  <div style="max-width:1100px;margin:0 auto;width:100%;">
    <div class="title title__default"><h1 style="font-size:clamp(32px,5.5vw,56px);line-height:1.15;margin:0 0 20px;">AI Automatisering &amp; Voice Receptionists by Industry</h1></div>
    ...
    <p style="margin-top:28px;">
      <a href="/nl/contact/" class="button" style="display:inline-block;background:#227bf3;color:#fff;padding:15px 32px;border-radius:8px;font-weight:600;font-size:16px;text-decoration:none;">Schedule an AI Demo Call</a>
    </p>
  </div>
</div>
      ...
      <div style="border:1px solid rgba(128,128,128,0.22);border-radius:14px;padding:28px;background:rgba(255,255,255,0.03);display:flex;flex-direction:column;justify-content:space-between;">
        <div>
          ...
          <h3 style="font-size:22px;font-weight:700;margin:0 0 12px;line-height:1.3;">
            <a href="/nl/ai-solutions/${sol.slug}/" style="color:inherit;text-decoration:none;">${sol.name}</a>
          </h3>
        ...
        <div>
          <a href="/nl/ai-solutions/${sol.slug}/" style="display:inline-flex;align-items:center;font-weight:600;font-size:15px;color:#227bf3;text-decoration:none;">
...
<section ${S}>
  <h2 ${H2}>Pair AI Automatisering With a Custom Website</h2>
  ...
  <p style="margin:20px 0;">
    <a href="/nl/industries/" style="font-weight:700;font-size:17px;color:#227bf3;text-decoration:none;">Explore Webdesign by Industry &rsaquo;</a>
  </p>
</section>
...
<section ${S} style="text-align:center;padding:30px 24px 60px;">
  <div style="background:rgba(255,255,255,0.02);border:1px solid rgba(128,128,128,0.2);border-radius:16px;padding:40px 24px;">
    ...
    <a href="/nl/contact/" class="button" style="display:inline-block;background:#227bf3;color:#fff;padding:14px 32px;border-radius:8px;font-weight:600;text-decoration:none;">Request a Live AI Demo &rsaquo;</a>
  </div>
</section>
`;
}
    ...
    '@graph': [
      {
        '@type': 'Service',
        '@id': `${url}#service`,
        name: 'AI Automatisering & Voice Receptionists by Industry',
        serviceType: 'AI Agent & Voice Receptionist Ontwikkeling',
