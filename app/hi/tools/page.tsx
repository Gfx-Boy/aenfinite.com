...
export const metadata: Metadata = {
  title: 'Our टेक Stack — AI, ऑटोमेशन & डेवलपमेंट Tools | Aenfinite',
...
function buildHubContent(): string {
  ...
  const cards = TOOLS.map(t => `
    <a href="/hi/tools/${t.slug}/" style="text-decoration:none;color:inherit;display:block;background:rgba(255,255,255,0.03);border:1px solid rgba(128,128,128,0.2);border-radius:16px;padding:28px 24px;transition:all 0.3s ease;">
      ...
      <span style="font-size:14px;font-weight:600;color:#227bf3;">और जानें &rsaquo;</span>
    </a>
  `).join('\n');
...
<div class="header aen-dark-mode" style="min-height:42vh;display:flex;align-items:center;padding:130px 24px 50px;">
  <div style="max-width:1100px;margin:0 auto;width:100%;">
    <div class="title title__default"><h1 style="font-size:clamp(32px,5.5vw,56px);line-height:1.15;margin:0 0 20px;">Our टेक Stack</h1></div>
    ...
    '@graph': [
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'टेक Stack', item: url },
        ],
      },
    ],
  };
