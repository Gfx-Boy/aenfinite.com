...
export const metadata: Metadata = {
  title: 'Honest Comparisons — AI, वेब डिज़ाइन & Tools | Aenfinite',
...
function buildHubContent(): string {
  ...
  const cards = COMPARISONS.map(c => `
    <a href="/hi/compare/${c.slug}/" style="text-decoration:none;color:inherit;display:block;background:rgba(255,255,255,0.03);border:1px solid rgba(128,128,128,0.2);border-radius:16px;padding:28px 24px;transition:all 0.3s ease;">
