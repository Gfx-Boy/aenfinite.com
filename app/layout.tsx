  ...
  return (
    <html lang="en" className={`${manrope.variable} ${manrope.className}`}>
      <head>
        ...
        {/* Global zero-FOUT typography definition using Next.js self-hosted Manrope */}
        <style dangerouslySetInnerHTML={{ __html: `
          :root {
            --font-manrope: ${manrope.style.fontFamily}, 'Manrope', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;
          }
          html, body, *, input, button, textarea, select, .document {
            font-family: var(--font-manrope), 'Manrope', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif !important;
          }
        ` }} />
      ...
      <body className={manrope.className}>
        ...
        {/* Global Organization Schema for AI Search / LLMO */}
        <OrganizationSchema />
      </body>
    </html>
  );
